...
## 데이터베이스  
  ...
  : 맴버와 상품 게시판 테이블을 중심
  <p align="center"><img src="../assets/img/safe_food/erd.png" width="70%" height="7%"></p>
...
## BMI 알고리즘  
  <p align="center"><img src="../assets/img/safe_food/algorithm.PNG" width="80%" height="8%"></p>
 
## 페이지  
 1.메인페이지 : 기본 상품 6개를 전시 [+] 상품명 | 제조사 | 영양분 | 검색기능
 <p align="center"><img src="../assets/img/safe_food/mainpage.png" width="60%" height="60%"></p>  
 ...
 3.마이페이지 : 내 정보 및 나의 섭취식품 선호식품을 바탕으로한 영양 정보 제공
  <p align="center"><img src="../assets/img/safe_food/mypage.png" width="60%" height="6%"></p>  
 4.게시판 : 게시물 등록 수정 제거 기능
  <p align="center"><img src="../assets/img/safe_food/board.png" width="60%" height="60%"></p>  
 
## 결과
  <p align="center"><img src="../assets/img/safe_food/result.PNG" width="60%" height="6%"></p>
